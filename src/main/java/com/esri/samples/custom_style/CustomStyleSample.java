...
public class CustomStyleSample extends Application {
        ...
        for (String symbolName : symbolNames) {
          ...
          searchResult.addDoneListener(() -> {
            try {
              ...
              switch (symbolName) {
                case "Beetle":
                  System.out.println("Beetle symbol");
                ...
                case "Fly":
                  ...
                  break;
                case "Moth":
                  System.out.println("Moth symbol");
                  ...
                  break;
                case "Wasp":
                  System.out.println("Wasp symbol");
  ...
  private void addMobileGDBData(Renderer renderer) {
    ...
    geodatabase.addDoneLoadingListener(() -> {
      ...
      System.out.println("gdb stat " + geodatabase.getLoadStatus());
    });
  }
